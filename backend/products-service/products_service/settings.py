...
Production-ready settings with Redis caching, PostgreSQL, and OpenTelemetry.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'dotnetcv'),
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Products Service API for product management',
    'VERSION': '1.0.0',
